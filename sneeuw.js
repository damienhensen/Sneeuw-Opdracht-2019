...
class Sneeuw {
  constructor( horizontaal, verticaal, snelheid ) {
    this._sapwereled = horizontaal;
    this._liluzivert = verticaal;
    this._lightningmcqueen = snelheid;
    this._sneeuw;
  }
  ...
  maken() {
    ...
    this._sneeuw.className  = 'sneeuw-div';
    this._sneeuw.style.top  = this._liluzivert + 'px';
    this._sneeuw.style.left = this._sapwereled + 'px';
    document.getElementById('midden').appendChild(this._sneeuw);
    this.rijden();
  }
